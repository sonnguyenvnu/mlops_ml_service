...
# Required for GCS. cd ~/.config/gcloud && sudo nano application_default_credentials.json
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = './service-account-gcs.json'

model = tf.keras.models.load_model(
    'gs://uet-mlflow/example_experiment/06d964a0070f45709edcfabb9854fd62/models/ckpt_epoch_7c')
